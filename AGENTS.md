...
4. Almacenar todo en una base de datos estructurada, consultable y exportable, para que una IA (Codex, ChatGPT, etc.) pueda leer los datos posteriormente y generar informes, resúmenes y tablas.
...
- **Compatibilidad con IAs locales (Ollama, LM Studio, etc.):** además de generar archivos exportables para pegar en un chat con Codex/ChatGPT, la app debe poder enviar los datos directamente a un modelo corriendo en local:
...
## Cómo leer los datos desde un agente de IA con acceso a esta carpeta (Codex, Codex CLI...)
